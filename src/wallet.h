...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 1000 NODEX at the same time
};
...
public:
    ...
    std::map<std::string, CnodexNodeConfig> mapMynodexNodes;
    bool AddnodexNodeConfig(CnodexNodeConfig nodeConfig);
