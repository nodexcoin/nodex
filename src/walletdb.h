...
public:
    ...
    bool WritenodexNodeConfig(std::string sAlias, const CnodexNodeConfig& nodeConfig);
    bool ReadnodexNodeConfig(std::string sAlias, CnodexNodeConfig& nodeConfig);
    bool ErasenodexNodeConfig(std::string sAlias);
